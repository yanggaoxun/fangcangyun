...
{
    protected static ?string $model = SysUser::class;
            ...
            ->schema([
                ...
                Forms\Components\Select::make('roles')
                    ...
                    ->options(function () use ($currentUser) {
                        ...
                        if ($currentUser->isSuperAdmin()) {
                            return SysRole::pluck('label', 'id');
                        }
                        // 系统管理员只能分配基地管理员
                        if ($currentUser->isSystemAdmin()) {
                            return SysRole::where('name', 'base_admin')->pluck('label', 'id');
                        }
                ...
                Forms\Components\Select::make('base_id')
                    ...
                    ->visible(function ($get) {
                        ...
                        $baseAdminRole = SysRole::where('name', 'base_admin')->first();
                        if (! $baseAdminRole) {
                            return false;
                        }
    ...
    {
        return Auth::user()->hasPermission('system.users.view');
    }

    public static function canCreate(): bool
    {
        return Auth::user()->hasPermission('system.users.create');
    }
    ...
    public static function canEdit(Model $record): bool
    {
        ...
        // 检查是否有编辑权限
        if (! $user->hasPermission('system.users.edit')) {
            return false;
        }
    ...
    public static function canDelete(Model $record): bool
    {
        ...
        // 检查是否有删除权限
        if (! $user->hasPermission('system.users.delete')) {
            return false;
        }
