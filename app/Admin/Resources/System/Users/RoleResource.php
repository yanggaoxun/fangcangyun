...
{
    protected static ?string $model = SysRole::class;
        ...
        return $schema
            ->schema([
                ...
                Forms\Components\CheckboxList::make('permissions')
                    ...
                    ->options(function () {
                        return SysPermission::all()->pluck('label', 'id')->toArray();
                    })
                    ->columns(2)
                    ->gridDirection('row')
                    ->columnSpanFull(),
    ...
    {
        return Auth::user()->hasPermission('system.roles.view');
    }

    public static function canCreate(): bool
    {
        return Auth::user()->hasPermission('system.roles.create');
    }

    public static function canEdit(Model $record): bool
    {
        return Auth::user()->hasPermission('system.roles.edit');
    }
    ...
    public static function canDelete(Model $record): bool
    {
        ...
        return Auth::user()->hasPermission('system.roles.delete');
    }
