...
namespace App\Admin\Resources\Mushroom\Batches;

use App\Admin\Resources\Mushroom\Batches\Pages\CreateBatch;
use App\Admin\Resources\Mushroom\Batches\Pages\EditBatch;
use App\Admin\Resources\Mushroom\Batches\Pages\ListBatches;
use App\Admin\Resources\Mushroom\Batches\Tables\BatchesTable;
...
{
    protected static ?string $model = MushroomBatch::class;
        ...
        return $schema
            ->schema([
                ...
                Forms\Components\Select::make('base_id')
                    ...
                    ->required()
                    ->options(function () {
                        return ChamberBase::pluck('name', 'id');
                    })
                    ->searchable()
                    ->live()
                    ->hiddenOn('edit')
