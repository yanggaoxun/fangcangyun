...
namespace App\Admin\Resources\Mushroom\Strains;

use App\Admin\Resources\Mushroom\Strains\Pages\CreateMushroomStrain;
use App\Admin\Resources\Mushroom\Strains\Pages\EditMushroomStrain;
use App\Admin\Resources\Mushroom\Strains\Pages\ListMushroomStrains;
use App\Admin\Resources\Mushroom\Strains\Tables\MushroomStrainsTable;
...
class MushroomStrainResource extends Resource
{
    ...
    protected static ?string $slug = 'mushroom/strains';
                ...
                Repeater::make('base_stocks')
                    ...
                    ->schema([
                        Select::make('base_id')
                            ->label('基地')
                            ->required()
                            ->options(fn () => ChamberBase::pluck('name', 'id'))
                            ->searchable()
                            ->distinct(), // 防止重复选择同一基地
